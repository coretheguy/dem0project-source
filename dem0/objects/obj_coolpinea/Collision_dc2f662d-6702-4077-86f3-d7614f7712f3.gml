if ((stun == 0) && ((obj_player.y >= y + 10) && ((obj_player.attacking == 0) && ((obj_player.state != 51) && ((obj_player.state != 50) && ((obj_player.state != 35) && ((!(vsp < 0)) && (obj_player.instakillmove == 0) && obj_player.state != 64)))))))
{
...
if ((obj_player.y < y) && ((obj_player.state != 51) && ((obj_player.attacking == 0) && ((obj_player.state != 35) && ((obj_player.state != 50) && ((!(vsp < 0)) && (obj_player.instakillmove == 0)))))))
{
    if (x != other.x)
    {
        hsp = (sign((x - obj_player.x)) * 3)
