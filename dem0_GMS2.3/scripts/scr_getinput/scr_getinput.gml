function scr_getinput() {
	...
	key_left2 = (-(keyboard_check_pressed(global.key_left) || gamepad_button_check_pressed(0, gp_padl)))
	key_down = (keyboard_check(global.key_down) || gamepad_button_check(0, gp_padd))
	key_down2 = (keyboard_check_pressed(global.key_down) || gamepad_button_check_pressed(0, gp_padd))
	key_jump = (keyboard_check_pressed(global.key_jump) || gamepad_button_check_pressed(0, gp_face1))
	key_jump2 = (keyboard_check(global.key_jump) || gamepad_button_check(0, gp_face1))
	key_attack = (keyboard_check(global.key_attack) || gamepad_button_check(0, gp_face3))
	key_attack2 = (keyboard_check_pressed(global.key_attack) || gamepad_button_check_pressed(0, gp_face3))
	...
	key_chainsaw = (keyboard_check(global.key_slap) || gamepad_button_check(0, gp_shoulderr))
